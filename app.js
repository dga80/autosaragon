          ...
          <div class="p-4 sm:p-5 flex flex-col flex-1 justify-between">
            ...
            <div class="pt-3 border-t border-white/5 flex items-end justify-between gap-3">
              <div>
                ...
                <div class="font-sora font-extrabold text-xl sm:text-2xl text-white tracking-tight">${car.specs.precio}</div>
                <div class="text-[11px] font-mono text-rose-400">Desde ${car.cuota}</div>
              </div>

              <div class="flex items-center gap-1.5">
                <!-- WhatsApp Quick Trigger -->
                <a href="https://wa.me/34932328715?text=Hola%20Autos%20Arag%C3%B3n,%20me%20interesa%20el%20${encodeURIComponent(car.title)}%20(${encodeURIComponent(car.specs.precio)}).%20%C2%BFSigue%20disponible?" target="_blank" rel="noopener" class="w-10 h-10 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-400 border border-emerald-500/30 flex items-center justify-center transition-all touch-press" title="Consultar por WhatsApp">
            ...
            <div class="p-4 rounded-xl bg-gradient-to-br from-rose-950/40 via-slate-900 to-slate-900 border border-rose-500/20 mb-5">
              <div class="flex items-baseline justify-between">
                <div>
                  ...
                  <div class="font-sora font-extrabold text-3xl text-white tracking-tight">${car.specs.precio}</div>
                </div>
                <div class="text-right">
                  <div class="text-xs font-mono text-rose-400">Financiación flexible</div>
                  <div class="font-sora font-bold text-lg text-rose-300">Desde ${car.cuota}</div>
                </div>
              </div>
